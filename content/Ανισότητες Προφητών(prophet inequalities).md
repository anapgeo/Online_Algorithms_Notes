...
$$
Ε[ALG_τ]= p_τ\cdot τ + \sum_{i=1}^{n} Pr[\bigwedge_{j<i} X_j<τ]\cdot E[(X_i - τ)^+] \geq Ε[ALG_τ]= p_τ\cdot τ + (1-p_τ)\cdot \sum_{i=1}^{n}E[(X_i - τ)^+] 
$$
...
$$
άρα για το αναμενόμενο κέρδος του $ALG_τ$ τελικά ισχύει:
