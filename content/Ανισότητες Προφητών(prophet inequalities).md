...
Η ανάλυση για την επιλογή της μέσης τιμής μοιάζει πολύ με αυτή που κάναμε και για τον διάμεσο.

Ξεκινάμε από τη σχέση που εκφράζει το κέρδος κάθε αλγοορίθμου κατωφλιού $ALG_τ$
...
Αντικαθιστούμε $τ=\frac{1}{2}E[X_{max}]$:
