...
Ας εξετάσουμε έναν οποιοδήποτε αλγόριθμο σήμανσης σε μια cache με k θέσεις. Συγκεκριμένα έχουμε μια ακολουθία αιτημάτων $\sigma$. Θεωρούμε πως στην $\sigma$ περιέχονται αιτήματα για k+1 διακριτά στοιχεία. 
